...
# In Windows offet das eine eigende Chrome instanz. diese muss anschließend geschlossen werden
def get_chrome_version(chrome_binary: str, timeout_seconds: int = 2) -> str:
    # Erstellt eigentlichen Sub Prozess
    ...
    try:
        ...
        return "Get Chrome Version Timeout"
...
def chrome_request(
    ...
    event_id = f"chrome-{uuid.uuid4().hex[:12]}"
...
def run_chrome(url: str, chrome_binary: str, wait_seconds: int = 5) -> None:
    options = Options()
